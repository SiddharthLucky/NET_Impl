...
namespace MyLinqTest
{
    ...
    partial void InsertTestTab(TestTab instance);
    partial void UpdateTestTab(TestTab instance);
    partial void DeleteTestTab(TestTab instance);
    #endregion
		
		public LinqTestDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["DbTestConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<TestTab> TestTabs
		{
			get
			{
				return this.GetTable<TestTab>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.TestTab")]
	public partial class TestTab : INotifyPropertyChanging, INotifyPropertyChanged
	{
